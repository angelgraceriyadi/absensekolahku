        ...
        <div class="page-wrapper">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="../barang/data-barang.php">Data Barang Baik</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
            ...
            <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Laporan Data Barang Baik</h4>
                                <h6 class="card-subtitle">Informasi data barang kondisi baik tersedia pada tabel berikut</h6>
