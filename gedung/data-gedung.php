                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="../gedung/form-ubah-gedung.php?id_gedung= <?php echo $data['id_gedung']; ?>" name="id_gedung" type="submit" class="btn waves-effect waves-light btn-warning"><i class="far fa-edit"></i> Edit</a>
                                                        <a href="../gedung/hapus-gedung.php?id_gedung= <?php echo $data['id_gedung']; ?>" onclick="return confirm('Apakah anda yakin untuk menghapus data gedung ?')" name="id_gedung" type="submit" class="btn waves-effect waves-light btn-danger"><i class="fas fa-trash"></i> Hapus</a>
                                                    </td>
                                                </tr>
